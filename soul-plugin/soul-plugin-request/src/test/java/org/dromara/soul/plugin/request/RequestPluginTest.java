...
import org.dromara.soul.plugin.request.RequestPlugin;
...
public class RequestPluginTest {
    ...
    public void setup() {
        ...
        RequestHandle.SoulRequestHeader requestHeader = requestHandle.new SoulRequestHeader(
                ImmutableMap.of("addKey", "addValue"), ImmutableMap.of("replaceKey", "newKey"),
                ImmutableMap.of("setKey", "newValue"), Sets.newSet("removeKey")
        );

        RequestHandle.SoulRequestParameter requestParameter = requestHandle.new SoulRequestParameter(
                ImmutableMap.of("addKey", "addValue"), ImmutableMap.of("replaceKey", "newKey"),
                ImmutableMap.of("setKey", "newValue"), Sets.newSet("removeKey")
        );
        RequestHandle.SoulCookie cookie = requestHandle.new SoulCookie(
                ImmutableMap.of("addKey", "addValue"), ImmutableMap.of("replaceKey", "newKey"),
                ImmutableMap.of("setKey", "newValue"), Sets.newSet("removeKey")
        );

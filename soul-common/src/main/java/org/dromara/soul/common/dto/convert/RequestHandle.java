...
public class RequestHandle {
    private SoulRequestHeader header;

    private SoulRequestParameter parameter;

    private SoulCookie cookie;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public class SoulRequestHeader {
        /**
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public class SoulRequestParameter {
